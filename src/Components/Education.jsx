          ...
          <div className="form" id='education-form'>
              <div className="row">
                  <div className="col">
                      ...
                      <input type="text" className="form-control" id='edu-inp' placeholder='TheBestSchool' name='schoolname'/>
                  </div>
                  <div className="col">
              ...
              <div className="row">
                  <div className="col">
                      ...
                      <input type="date" className="form-control" id='edu-inp' name='sdate'/>
                  </div>
                  <div className="col">
                      <label htmlFor="dend" className="form-label">Course End date</label>
                      <input type="date" className="form-control" id='edu-inp' name='edate'/>
                  </div>
              </div>
